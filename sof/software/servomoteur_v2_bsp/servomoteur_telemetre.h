...
#ifndef __ALTERA_AVALON_TELEMETRE_MOTOR_H__
#define __ALTERA_AVALON_TELEMETRE_MOTOR_H__
...
// MOTOR
#define IOWR_ALTERA_AVALON_SERVOMOTEUR(data)	IOWR(AVALON_SERVOMOTEUR_BASE, 0, data)
...
#endif /* __ALTERA_AVALON_TELEMETRE_MOTOR_H__ */
