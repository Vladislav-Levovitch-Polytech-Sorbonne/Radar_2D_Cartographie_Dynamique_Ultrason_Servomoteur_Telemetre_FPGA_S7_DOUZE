...
#ifndef __ALTERA_AVALON_TELEMETRE_DIX_H__
#define __ALTERA_AVALON_TELEMETRE_DIX_H__
...
// Servomoteur
#define IOWR_ALTERA_AVALON_SERVOMOTEUR()		IOWR(AVALON_SERVOMOTEUR_BASE, 0,data)
...
#endif /* __ALTERA_AVALON_TELEMETRE_DIX_H__ */
