...
// UART
#define	IOWR_ALTERA_AVALON_UART_Load(data)   	IOWR_32DIRECT(UART_BASE, 0x0, data)
#define IOWR_ALTERA_AVALON_UART_Tx_ASCii(data)  IOWR_32DIRECT(UART_BASE, 0x4, data)
#define IOWR_ALTERA_AVALON_UART_Rx_ASCii() 		IORD_32DIRECT(UART_BASE, 0x8)
