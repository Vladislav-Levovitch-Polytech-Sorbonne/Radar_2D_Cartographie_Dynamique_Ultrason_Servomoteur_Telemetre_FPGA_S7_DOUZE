...
module Computer_System_mm_interconnect_0 (
	...
	wire   [19:0] cmd_mux_001_src_channel;                                                              // cmd_mux_001:src_channel -> avalon_telemetre_avalon_slave_0_agent:cp_channel
	...
	wire   [19:0] cmd_demux_001_src5_channel;                                                           // cmd_demux_001:src5_channel -> cmd_mux_006:sink1_channel
	...
	wire   [19:0] rsp_demux_006_src1_channel;                                                           // rsp_demux_006:src1_channel -> rsp_mux_001:sink5_channel
	...
	wire          cmd_demux_001_src7_valid;                                                             // cmd_demux_001:src7_valid -> JTAG_to_FPGA_Bridge_master_to_SDRAM_s1_cmd_width_adapter:in_valid
	wire  [111:0] cmd_demux_001_src7_data;                                                              // cmd_demux_001:src7_data -> JTAG_to_FPGA_Bridge_master_to_SDRAM_s1_cmd_width_adapter:in_data
	wire          cmd_demux_001_src7_ready;                                                             // JTAG_to_FPGA_Bridge_master_to_SDRAM_s1_cmd_width_adapter:in_ready -> cmd_demux_001:src7_ready
	wire   [19:0] cmd_demux_001_src7_channel;                                                           // cmd_demux_001:src7_channel -> JTAG_to_FPGA_Bridge_master_to_SDRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_001_src7_startofpacket;                                                     // cmd_demux_001:src7_startofpacket -> JTAG_to_FPGA_Bridge_master_to_SDRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_001_src7_endofpacket;                                                       // cmd_demux_001:src7_endofpacket -> JTAG_to_FPGA_Bridge_master_to_SDRAM_s1_cmd_width_adapter:in_endofpacket
	...
	wire          sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_valid;                   // SDRAM_s1_to_JTAG_to_FPGA_Bridge_master_rsp_width_adapter:out_valid -> rsp_mux_001:sink7_valid
	wire  [111:0] sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_data;                    // SDRAM_s1_to_JTAG_to_FPGA_Bridge_master_rsp_width_adapter:out_data -> rsp_mux_001:sink7_data
	wire          sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_ready;                   // rsp_mux_001:sink7_ready -> SDRAM_s1_to_JTAG_to_FPGA_Bridge_master_rsp_width_adapter:out_ready
	wire   [19:0] sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_channel;                 // SDRAM_s1_to_JTAG_to_FPGA_Bridge_master_rsp_width_adapter:out_channel -> rsp_mux_001:sink7_channel
	wire          sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_startofpacket;           // SDRAM_s1_to_JTAG_to_FPGA_Bridge_master_rsp_width_adapter:out_startofpacket -> rsp_mux_001:sink7_startofpacket
	wire          sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_endofpacket;             // SDRAM_s1_to_JTAG_to_FPGA_Bridge_master_rsp_width_adapter:out_endofpacket -> rsp_mux_001:sink7_endofpacket
	...
	Computer_System_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		...
		.sink7_ready          (sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_ready),         //     sink7.ready
		.sink7_valid          (sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_valid),         //          .valid
		.sink7_channel        (sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_channel),       //          .channel
		.sink7_data           (sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_data),          //          .data
		.sink7_startofpacket  (sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink7_endofpacket    (sdram_s1_to_jtag_to_fpga_bridge_master_rsp_width_adapter_src_endofpacket),   //          .endofpacket
